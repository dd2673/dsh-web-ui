// Upstream regression suite from Lum1104/dsh-browser 782c61d; MIT, see ../src/host/LICENSE.dsh-browser.
import { describe, expect, it, vi } from 'vitest'
import {
  createRemoteHostApi,
  type HostConnectionLike,
  type TypertGatewayLike,
} from '../src/host/remote-host-api.ts'
import type { HostRpcCall } from '../src/host/host-api.ts'
