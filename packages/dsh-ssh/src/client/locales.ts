...
export const zh = {
  ...
  'hosts.trustKey': '验证主机密钥',
  'hosts.refreshKey': '重新验证密钥',
  'hosts.scanningKey': '正在读取密钥…',
  'hosts.keyTrusted': '密钥已验证',
  'hosts.sameEndpoint': '同机账号：{aliases}',
  'hosts.credentialReady': '凭据已就绪',
  'hosts.credentialMissing': '凭据缺失',
  'hosts.secretDpapi': 'DPAPI 当前用户加密',
  'hosts.secretFile': '0600 私有文件',
  'hosts.secretLegacy': '旧版明文，保存后升级',
  'hosts.secretNone': '无存储密码/口令',
  'hosts.trustConfirm': '服务器「{alias}」报告主机密钥：\n{fingerprint}\n\n请与服务器管理员提供的指纹核对。确认信任该密钥吗？',
  'hosts.trustOk': '已信任「{alias}」的主机密钥 {fingerprint}。',
  'hosts.connected': '连接',
  ...
  'form.password': '密码',
  'form.passwordHint': 'Windows 使用当前用户 DPAPI 加密保存；其他系统保存于权限为 0600 的本机私有文件',
...
export const en: Record<keyof typeof zh, string> = {
  ...
  'hosts.trustKey': 'Verify host key',
  'hosts.refreshKey': 'Re-verify key',
  'hosts.scanningKey': 'Reading key…',
  'hosts.keyTrusted': 'Key verified',
  'hosts.sameEndpoint': 'Same endpoint: {aliases}',
  'hosts.credentialReady': 'Credential ready',
  'hosts.credentialMissing': 'Credential missing',
  'hosts.secretDpapi': 'DPAPI current-user protected',
  'hosts.secretFile': 'Private 0600 file',
  'hosts.secretLegacy': 'Legacy plaintext; upgraded on save',
  'hosts.secretNone': 'No stored password/passphrase',
  'hosts.trustConfirm': 'Server "{alias}" presented this host key:\n{fingerprint}\n\nCompare it with the fingerprint supplied by the server administrator. Trust this key?',
  'hosts.trustOk': 'Trusted host key {fingerprint} for "{alias}".',
  ...
  'form.passwordHint': 'Encrypted with current-user DPAPI on Windows; stored in a local 0600 private file on other systems',
